...
export default function CrappyBirthday() {
  ...
  const accountContext = useContext(AccountContext)
    ...
    useEffect(()=>{
        ...
        script.src = "js/crappy-birthday-popup.js";
        script.async = true;
    ...
    video.src = "https://festivfilms.s3.us-east-2.amazonaws.com/Crappy+Birthday.mp4";
  ...
  shareButton.href ="mailto:?subject=Crappy%20Birthday%20(2018)&body=https://festivmedia.com/screening-room-crappy-birthday";
  ...
  <div className="section-3">
    <div id="video-wrapper" className="div-block-47"><img src="images/crappy-birthday-backdrop.png" id="filler-image" sizes="(max-width: 991px) 90vw, (max-width: 1439px) 70vw, 899.9999389648438px" srcSet="images/crappy-birthday-backdrop-p-500.png 500w, images/crappy-birthday-backdrop-p-800.png 800w, images/crappy-birthday-backdrop-p-1080.png 1080w, images/crappy-birthday-backdrop-p-1600.png 1600w, images/crappy-birthday-backdrop.png 1621w" alt="" className="image-35"/>
  ...
  <div className="film-description-section">
    <div className="w-layout-grid grid-16">
      <div>
        <div className="w-layout-grid grid-17"><img src="images/crappy-birthday.png" width="140" sizes="(max-width: 479px) 180px, (max-width: 767px) 38vw, 219.99998474121094px" srcSet="images/crappy-birthday-p-500.png 500w, images/crappy-birthday-p-800.png 800w, images/crappy-birthday-p-1080.png 1080w, images/crappy-birthday.png 1200w" alt="" className="image-24"/>
          <div className="div-block-38">
            <div className="text-block-25">CRAPPY BIRTHDAY</div>
            <div className="text-block-26">2018</div>
            <div className="text-block-27">When Matt’s wife ditches him on his birthday for a free ticket to Coachella, he ends up with a birthday present that will change his life.</div>
            <div className="text-block-28">11 min  |  English  |  USA</div>
          </div>
        </div>
      </div>
      <div className="div-block-34">
        <div className="text-block-24">16,763 Views</div><img src="images/martini-rating-icons-no-mouse.png" width="117" sizes="(max-width: 479px) 42vw, 116.98863220214844px" srcSet="images/martini-rating-icons-no-mouse-p-500.png 500w, images/martini-rating-icons-no-mouse-p-800.png 800w, images/martini-rating-icons-no-mouse.png 1140w" alt="" className="image-20"/>
  ...
  <div className="cast-and-crew-section">
    ...
    <div className="film-members-line">
      ...
      <div className="actor-hyperlink erez-link-one">MARC FELLNER-EREZ</div>
    </div>
    <div className="film-members-line">
      <div className="text-block-18">PRODUCERS:</div>
      <div className="actor-hyperlink wilson-link">ERIN FAITH WILSON</div>
      <div className="text-block-19">,</div>
      <div className="actor-hyperlink gray-link">TIFFANY GRAY</div>
    </div>
    <div className="film-members-line">
      <div className="text-block-18">STARS:</div>
      <div className="actor-hyperlink snell-link">DAVE SNELL</div>
      <div className="text-block-19">,</div>
      <div className="actor-hyperlink samp-link">BUCKLEY SAMPSON</div>
      <div className="text-block-19">,</div>
      <div className="actor-hyperlink tobias-link">ELIZABETH TOBIAS</div>
      <div className="text-block-19">,</div>
      <div className="actor-hyperlink erez-link-two">MARC FELLNER-EREZ</div>
      <div className="text-block-19 cast-and-crew-line"> | </div>
      <a href="https://www.imdb.com/title/tt7227446/" target="_blank" className="w-inline-block">
        <div className="actor-hyperlink">SEE FULL CAST &amp; CREW &gt;&gt;</div>
      </a>
    </div>
    <div className="share-film-wrapper">
      <a id="screening-room-contact" href="mailto:mike@upstartcrowfilms.com?subject=Inquiry%20About%20Crappy%20Birthday%20(2018)" className="contact-filmmaker-button w-button">CONTACT FILMMAKER</a>
      <a id="screening-room-share" href="#" className="share-film-button w-button">SHARE FILM</a>
    </div><img src="images/mike-peebler.png" width="68" sizes="100vw" srcSet="images/mike-peebler-p-500.png 500w, images/mike-peebler.png 800w" alt="" className="image-26"/><img src="images/Unknown-Photo.png" width="68" sizes="100vw" srcSet="images/Unknown-Photo-p-500.png 500w, images/Unknown-Photo.png 800w" alt="" className="image-27"/><img src="images/dave-snell.png" width="68" sizes="100vw" srcSet="images/dave-snell-p-500.png 500w, images/dave-snell.png 800w" alt="" className="image-28"/><img src="images/buckley-sampson.png" width="68" sizes="100vw" srcSet="images/buckley-sampson-p-500.png 500w, images/buckley-sampson.png 800w" alt="" className="image-28"/><img src="images/elizabeth-tobais.png" width="68" sizes="100vw" srcSet="images/elizabeth-tobais-p-500.png 500w, images/elizabeth-tobais.png 800w" alt="" className="image-28"/>
