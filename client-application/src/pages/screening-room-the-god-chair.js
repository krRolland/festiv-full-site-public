...
export default function TheGodChair() {
  
    useEffect(()=>{
        // inject popup script
        const script = document.createElement("script");
        script.src = "js/the-god-chair-popup.js";
        script.async = true;
        ...
        shareButton.href ="mailto:?subject=The%20God%20Chair%20(2016)&body=https://festivmedia.com/screening-room-the-god-chair";
  ...
  let videoWrapper = document.getElementById("video-wrapper");
    ...
    video.src = "https://festivfilms.s3.us-east-2.amazonaws.com/The+God+Chair.mp4";
  ...
  <div className="section-3">
    <div id="video-wrapper" className="div-block-47"><img srcSet="images/the-god-chair-backdrop.png" id="filler-image" sizes="(max-width: 991px) 90vw, (max-width: 1439px) 70vw, 900px" srcset="images/the-god-chair-backdrop-p-500.png 500w, images/the-god-chair-backdrop-p-800.png 800w, images/the-god-chair-backdrop-p-1080.png 1080w, images/the-god-chair-backdrop.png 1621w" alt="" className="image-35"/>
      <div className="div-block-57"><img srcSet="images/screening-room-play-button.png" width="104" id="screening-room-play-button" alt="" className="image-31"/></div>
    </div>
  </div>
  <div className="film-description-section">
    <div className="w-layout-grid grid-16">
      <div>
        <div className="w-layout-grid grid-17"><img srcSet="images/the-god-chair.png" width="140" sizes="(max-width: 767px) 180px, 220px" srcset="images/the-god-chair-p-500.png 500w, images/the-god-chair-p-800.png 800w, images/the-god-chair-p-1080.png 1080w, images/the-god-chair.png 1200w" alt="" className="image-24"/>
          <div className="div-block-38">
            <div className="text-block-25">THE GOD CHAIR</div>
            <div className="text-block-26">2016</div>
            <div className="text-block-27">Three celestial beings tasked with guiding the newly deceased. As they sit in the God Chair, they struggle coming to terms with how they are supposed to do their duty or why.</div>
            <div className="text-block-28">14 min  |  English  |  USA</div>
          </div>
        </div>
      </div>
      <div className="div-block-34">
        <div className="text-block-24">16,763 Views</div><img srcSet="images/martini-rating-icons-no-mouse.png" width="117" sizes="(max-width: 991px) 100vw, (max-width: 1279px) 117px, 100vw" srcset="images/martini-rating-icons-no-mouse-p-500.png 500w, images/martini-rating-icons-no-mouse-p-800.png 800w, images/martini-rating-icons-no-mouse.png 1140w" alt="" className="image-20"/>
  ...
  <div className="cast-and-crew-section">
    ...
    <div className="film-members-line">
      ...
      <div className="actor-hyperlink peebler-link-one">MIKE PEEBLER</div>
    </div>
    <div className="film-members-line">
      <div className="text-block-18">WRITERS:</div>
      <div className="actor-hyperlink peebler-link-two">MIKE PEEBLER</div>
    ...
    <div className="film-members-line">
      ...
      <div className="actor-hyperlink gray-link">TIFFANY GRAY</div>
    </div>
    <div className="film-members-line">
      <div className="text-block-18">STARS:</div>
      <div className="actor-hyperlink shields-link">STEVEN SHIELDS</div>
      <div className="text-block-19">,</div>
      <div className="actor-hyperlink phil-link">EARNESTINE PHILLIPS</div>
      <div className="text-block-19">,</div>
      <div className="actor-hyperlink skye-link">ARI SKYE</div>
      <div className="text-block-19 cast-and-crew-line"> | </div>
      <a href="https://www.imdb.com/title/tt5027924/" target="_blank" className="w-inline-block">
        <div className="actor-hyperlink">SEE FULL CAST &amp; CREW &gt;&gt;</div>
      </a>
    </div>
    <div className="share-film-wrapper">
      <a href="mailto:mike@upstartcrowfilms.com?subject=Inquiry%20About%20The%20God%20Chair%20(2016)" id="screening-room-contact" className="contact-filmmaker-button w-button">CONTACT FILMMAKER</a>
      <a id="screening-room-share" href="#" className="share-film-button w-button">SHARE FILM</a>
    </div><img srcSet="images/mike-peebler.png" width="68" sizes="100vw" srcset="images/mike-peebler-p-500.png 500w, images/mike-peebler.png 800w" alt="" className="image-26"/><img srcSet="images/Unknown-Photo.png" width="68" sizes="100vw" srcset="images/Unknown-Photo-p-500.png 500w, images/Unknown-Photo.png 800w" alt="" className="image-26"/><img srcSet="images/earnestine-phillips.png" width="68" sizes="100vw" srcset="images/earnestine-phillips-p-500.png 500w, images/earnestine-phillips.png 800w" alt="" className="image-26"/>
    <div id="follow-me" className="follow-me-card">
      <div className="w-layout-grid grid-14"><img srcSet="images/rob-adler-headshot.png" width="103" id="profile-picture" alt="" className="image-23"/>
        <div className="div-block-35">
          ...
          <div className="div-block-36">
            <div className="div-block-42">
              <a id="imdb-link" href="https://www.imdb.com/name/nm0012228/?ref_=fn_al_nm_1" target="_blank" className="link-block-8 w-inline-block"><img srcSet="images/imdb-icon.png" width="45" sizes="(max-width: 1279px) 45px, (max-width: 1919px) 100vw, 45px" srcset="images/imdb-icon-p-500.png 500w, images/imdb-icon-p-800.png 800w, images/imdb-icon.png 1200w" alt="" className="image-22"/></a>
              <a href="https://www.instagram.com/adlerimprov/" target="_blank" className="follow-me-links w-inline-block"><img srcSet="images/blue-instagram-icon.png" alt=""/></a>
              <a href="#" className="follow-me-links w-inline-block"><img srcSet="images/blue-facebook-icon.png" alt=""/></a>
              <a href="https://twitter.com/adlerimprov" target="_blank" className="follow-me-links w-inline-block"><img srcSet="images/blue-twitter-icon.png" alt=""/></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div className="footer">
    ...
    <div className="w-layout-grid grid-7">
      ...
      <div id="w-node-e7f1494548f3-494548a4" className="div-block-41">
        <a href="https://www.instagram.com/festivmedia/?hl=en" className="social-link w-inline-block"><img srcSet="images/instagram-icon.png" alt=""/></a>
        <a href="https://www.facebook.com/Festiv-101470541497280" className="social-link w-inline-block"><img srcSet="images/facebook-icon.png" alt="" className="image-30"/></a>
        <a href="https://twitter.com/festiv12" className="social-link w-inline-block"><img srcSet="images/twitter-icon.png" alt=""/></a>
        <a href="mailto:info@festivmedia.com?subject=Inquiry%20About%20Festiv" className="social-link w-inline-block"><img srcSet="images/mail-icon.png" alt=""/></a>
      </div>
    </div>
  </div>
</div>
