...
export default function PaymentFaliure() {
    useEffect(()=>{
  ...
  <div className="section-11">
    <div className="sign-in-container w-container">
      <h1 className="sign-in-title">OOPS!</h1>
      <h1 className="success-message">It seems something went wrong with your submission. Try completing the payment form once again, or reach out to us at info@festivmedia.com</h1>
    </div>
  </div>
