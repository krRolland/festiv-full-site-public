...
export default function Ivote(){
    ...
    useEffect(()=>{
        ...
        shareButton.href ="mailto:?subject=iVote%20(2012)&body=https://festivmedia.com/screening-room-ivote";
  ...
  <div className="section-3">
    <div id="video-wrapper" className="div-block-47"><img src="images/ivote-keyart-horizontal-hq.png" id="filler-image" sizes="(max-width: 991px) 90vw, (max-width: 1439px) 70vw, 900px" srcSet="images/ivote-keyart-horizontal-hq-p-500.png 500w, images/ivote-keyart-horizontal-hq-p-800.png 800w, images/ivote-keyart-horizontal-hq.png 1080w" alt="" className="image-35"/>
  ...
  <div className="film-description-section">
    <div className="w-layout-grid grid-16">
      <div>
        <div className="w-layout-grid grid-17"><img src="images/ivote-keyart-vertical-hq.png" width="140" sizes="(max-width: 767px) 180px, 220px" srcSet="images/ivote-keyart-vertical-hq-p-500.png 500w, images/ivote-keyart-vertical-hq.png 738w" alt="" className="image-24"/>
          <div className="div-block-38">
            <div className="text-block-25">IVOTE</div>
            <div className="text-block-26 ivote-year-sc-room">2012</div>
            <div className="text-block-27">Academy Award nominee Eric Roberts (The Dark Knight), Dan Lauria (The Wonder Years, Sullivan &amp; Son) &amp; Emmy nominee Sharon Lawrence (NYPD Blue, Desperate Housewives) star in &quot;iVote,&#x27; the true story of a typist who exposes the sins of his own employer, all in the name of democracy. During George W. Bush&#x27;s re-election campaign, Steve is faced with a dilemma when he discovers that the company he works for helped to hide that the e-voting machines were fraudulent. &quot;iVote&quot; reveals the personal sacrifice and courage it takes to serve the greater good.</div>
            <div className="text-block-28">21 min  |  English  |  USA</div>
          </div>
        </div>
      </div>
  ...
  <div className="cast-and-crew-section">
    ...
    <div className="film-members-line">
      <div className="text-block-18">DIRECTORS: </div>
      <div className="actor-hyperlink adler-link-one">ROB ADLER</div>
    </div>
    <div className="film-members-line">
      <div className="text-block-18">WRITERS:</div>
      <div className="actor-hyperlink adler-link-two">ROB ADLER</div>
    </div>
    <div className="film-members-line">
      <div className="text-block-18">STARS:</div>
      <div className="actor-hyperlink roberts-link">ERIC ROBERTS</div>
      <div className="text-block-19">,</div>
      <div className="actor-hyperlink lauria-link">DAN LAURIA</div>
      <div className="text-block-19">,</div>
      <div className="actor-hyperlink lawrence-link">SHARON LAWRENCE</div>
      <div className="text-block-19 cast-and-crew-line"> | </div>
      <a href="https://www.imdb.com/title/tt2402308/" target="_blank" className="w-inline-block">
        <div className="actor-hyperlink">SEE FULL CAST &amp; CREW &gt;&gt;</div>
      </a>
    </div>
    <div className="share-film-wrapper">
      <a href="mailto:ivote.film@gmail.com?subject=Inquiry%20About%20iVote%20(2012)" id="screening-room-contact" className="contact-filmmaker-button w-button">CONTACT FILMMAKER</a>
      <a href="#" id="screening-room-share" className="share-film-button w-button">SHARE FILM</a>
    </div><img src="images/eric-roberts-headshot.png" width="68" sizes="100vw" srcSet="images/eric-roberts-headshot-p-500.png 500w, images/eric-roberts-headshot.png 785w" alt="" className="image-26"/><img src="images/dan-lauria-headshot.png" width="68" sizes="100vw" srcSet="images/dan-lauria-headshot-p-500.png 500w, images/dan-lauria-headshot.png 785w" alt="" className="image-27"/><img src="images/sharon-lawrence-headshot.png" width="68" sizes="100vw" srcSet="images/sharon-lawrence-headshot-p-500.png 500w, images/sharon-lawrence-headshot.png 785w" alt="" className="image-28"/>
