...
export default function LostAndFound() {
    ...
    useEffect(()=>{
        ...
        script.src = "js/lost-and-found-popup.js";
        script.async = true;
        document.body.appendChild(script);

        let shareButton = document.getElementById("screening-room-share");
        shareButton.href ="mailto:?subject=Lost%20And%20Found%20(2017)&body=https://festivmedia.com/screening-room-lost-and-found";
  ...
  let videoWrapper = document.getElementById("video-wrapper");
    ...
    video.src = "https://festivfilms.s3.us-east-2.amazonaws.com/lost+and+found.mp4";
  ...
  <div className="section-3">
    <div id="video-wrapper" className="div-block-47"><img src="images/lost-and-found-backdrop.png" id="filler-image" sizes="(max-width: 991px) 90vw, (max-width: 1439px) 70vw, 900px" srcSet="images/lost-and-found-backdrop-p-500.png 500w, images/lost-and-found-backdrop-p-800.png 800w, images/lost-and-found-backdrop-p-1080.png 1080w, images/lost-and-found-backdrop-p-1600.png 1600w, images/lost-and-found-backdrop.png 1620w" alt="" className="image-35"/>
  ...
  <div className="film-description-section">
    <div className="w-layout-grid grid-16">
      <div>
        <div className="w-layout-grid grid-17"><img src="images/lost-and-found.png" width="140" sizes="(max-width: 767px) 180px, 220px" srcSet="images/lost-and-found-p-500.png 500w, images/lost-and-found-p-800.png 800w, images/lost-and-found-p-1080.png 1080w, images/lost-and-found.png 1200w" alt="" className="image-24"/>
          <div className="div-block-38">
            <div className="text-block-25">LOST &amp; FOUND</div>
            <div className="text-block-26">2017</div>
            <div className="text-block-27">Arrogant and full of contempt for the world, Jamie learns his lesson the hard way and from a most unexpected source.</div>
            <div className="text-block-28">6 min  |  English  |  USA</div>
          </div>
        </div>
      </div>
  ...
  <div className="cast-and-crew-section">
    ...
    <div className="film-members-line">
      ...
      <div className="actor-hyperlink cooper-link-one">JAMES COOPER</div>
      <div className="text-block-19">,</div>
      <div className="actor-hyperlink peebler-link-two">MIKE PEEBLER</div>
    </div>
    <div className="film-members-line">
      <div className="text-block-18">PRODUCER:</div>
      <div className="actor-hyperlink cooper-link-two">JAMES COOPER</div>
    </div>
    <div className="film-members-line">
      <div className="text-block-18">STARS:</div>
      <div className="actor-hyperlink cotter-link">MICHAEL COTTER</div>
      <div className="text-block-19">,</div>
      <div className="actor-hyperlink clark-link">RONNIE CLARK</div>
      <div className="text-block-19 cast-and-crew-line"> | </div>
      <a href="https://www.imdb.com/title/tt6846630/" target="_blank" className="w-inline-block">
        <div className="actor-hyperlink">SEE FULL CAST &amp; CREW &gt;&gt;</div>
      </a>
    </div>
    <div className="share-film-wrapper">
      <a href="mailto:mike@upstartcrowfilms.com?subject=Inquiry%20About%20Lost%20And%20Found%20(2017)" id="screening-room-contact" className="contact-filmmaker-button w-button">CONTACT FILMMAKER</a>
      <a id="screening-room-share" href="#" className="share-film-button w-button">SHARE FILM</a>
    </div><img src="images/mike-peebler.png" width="68" sizes="100vw" srcSet="images/mike-peebler-p-500.png 500w, images/mike-peebler.png 800w" alt="" className="image-26"/><img src="images/Unknown-Photo.png" width="68" sizes="100vw" srcSet="images/Unknown-Photo-p-500.png 500w, images/Unknown-Photo.png 800w" alt="" className="image-26"/><img src="images/michael-cotter.png" width="68" sizes="100vw" srcSet="images/michael-cotter-p-500.png 500w, images/michael-cotter.png 800w" alt="" className="image-26"/><img src="images/ronnie-clark.png" width="68" sizes="100vw" srcSet="images/ronnie-clark-p-500.png 500w, images/ronnie-clark.png 800w" alt="" className="image-26"/>
