...
export default function OutWithABang(){
  
    useEffect(()=>{
        // inject popup script
        const script = document.createElement("script");
        script.src = "js/out-with-a-bang-popup.js";
        script.async = true;
        document.body.appendChild(script);

        // share film
        let shareButton = document.getElementById("screening-room-share");
        shareButton.href ="mailto:?subject=Out%20With%20A%20Bang%20(2016)&body=https://festivmedia.com/screening-room-out-with-a-bang";
  ...
  let videoWrapper = document.getElementById("video-wrapper");
    ...
    video.src = "https://festivfilms.s3.us-east-2.amazonaws.com/Out+With+a+Bang.mp4";
  ...
  <div className="section-3">
    <div id="video-wrapper" className="div-block-47"><img src="images/out-with-a-bang-backdrop.png" id="filler-image" sizes="(max-width: 991px) 90vw, (max-width: 1439px) 70vw, 900px" srcSet="images/out-with-a-bang-backdrop-p-500.png 500w, images/out-with-a-bang-backdrop-p-800.png 800w, images/out-with-a-bang-backdrop-p-1080.png 1080w, images/out-with-a-bang-backdrop-p-1600.png 1600w, images/out-with-a-bang-backdrop.png 1620w" alt="" className="image-35"/>
  ...
  <div className="film-description-section">
    <div className="w-layout-grid grid-16">
      <div>
        <div className="w-layout-grid grid-17"><img src="images/out-with-a-bang.png" width="140" sizes="(max-width: 767px) 180px, 220px" srcSet="images/out-with-a-bang-p-500.png 500w, images/out-with-a-bang-p-800.png 800w, images/out-with-a-bang-p-1080.png 1080w, images/out-with-a-bang.png 1200w" alt="" className="image-24"/>
          <div className="div-block-38">
            <div className="text-block-25">OUT WITH A BANG</div>
            <div className="text-block-26">2016</div>
            <div className="text-block-27">Alan Platt is having a terrible day in a lifetime full of terrible days. It only gets worse when his latest suicide attempt is interrupted by an unexpected visitor who shows Alan that life actually may be worth killing for.</div>
            <div className="text-block-28">15 min  |  English  |  USA</div>
          </div>
        </div>
      </div>
  ...
  <div className="cast-and-crew-section">
    ...
    <div className="film-members-line">
      ...
      <div className="actor-hyperlink blum-link">ALAN BLUMENFELD</div>
      <div className="text-block-19">,</div>
      <div className="actor-hyperlink kulik-link">ART KULIK</div>
      <div className="text-block-19 cast-and-crew-line"> | </div>
      <a href="https://www.imdb.com/title/tt5030354/" target="_blank" className="w-inline-block">
        <div className="actor-hyperlink">SEE FULL CAST &amp; CREW &gt;&gt;</div>
      </a>
    </div>
    <div className="share-film-wrapper">
      <a href="mailto:mike@upstartcrowfilms.com?subject=Inquiry%20About%20Out%20With%20A%20Bang%20(2016)" id="screening-room-contact" className="contact-filmmaker-button w-button">CONTACT FILMMAKER</a>
      <a id="screening-room-share" href="#" className="share-film-button w-button">SHARE FILM</a>
    </div><img src="images/mike-peebler.png" width="68" sizes="100vw" srcSet="images/mike-peebler-p-500.png 500w, images/mike-peebler.png 800w" alt="" className="image-26"/><img src="images/Unknown-Photo.png" width="68" sizes="100vw" srcSet="images/Unknown-Photo-p-500.png 500w, images/Unknown-Photo.png 800w" alt="" className="image-26"/><img src="images/alan-blumenfeld.png" width="68" sizes="100vw" srcSet="images/alan-blumenfeld-p-500.png 500w, images/alan-blumenfeld.png 800w" alt="" className="image-26"/><img src="images/art-kulik.png" width="68" sizes="100vw" srcSet="images/art-kulik-p-500.png 500w, images/art-kulik.png 800w" alt="" className="image-26"/>
